...
export const FOCUSED_PLATFORMS = ['codex', 'codex_api_service', 'claude_manager'] as const;
export const FOCUSED_PAGES = ['codex', 'codex-api-service', 'codex-instances', 'claude', 'claude-cli', '2fa', 'settings'] as const;
